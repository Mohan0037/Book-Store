  ...
  return (
    <div style={{ display: "flex", justifyContent: "center", alignItems: "center", minHeight: "100vh", padding: "1rem" }}>
      <div className="premium-card" style={{ padding: "2.5rem", width: "100%", maxWidth: "450px" }}>
        <h2 style={{ fontSize: "2rem", marginBottom: "0.5rem", textAlign: "center" }}>Reader Login</h2>
        <p style={{ color: "var(--text-secondary)", marginBottom: "2rem", textAlign: "center" }}>Enter details to browse and buy books</p>
        ...
        <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
          ...
          <button type="submit" className="premium-btn" style={{ marginTop: "1rem" }}>Log In</button>
        </form>

        <p style={{ marginTop: "1.5rem", textAlign: "center", color: "var(--text-secondary)", fontSize: "0.875rem" }}>
          Need an account? <span onClick={() => navigate("/user/signup")} style={{ color: "var(--accent-primary)", cursor: "pointer", fontWeight: "600" }}>Sign Up</span>
        </p>
      </div>
    </div>
  );
